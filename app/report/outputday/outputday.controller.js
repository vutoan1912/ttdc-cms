angular
    .module('erpApp')
    .controller('OutputDayController', OutputDayController);

    OutputDayController.$inject = ['$scope', '$rootScope', '$state', '$timeout', '$compile',
    ...
    function OutputDayController(
        ...
        $scope.getData = function () {
            ...
            var req = {
                method: 'GET',
                url: API_URL + '/api/sms/getThongKeNgay?' + query,
                headers: {
