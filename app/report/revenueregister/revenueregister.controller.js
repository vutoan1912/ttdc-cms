angular
    .module('erpApp')
    .controller('RevenueRegisterController', RevenueRegisterController);

    RevenueRegisterController.$inject = ['$scope', '$rootScope', '$state', '$timeout', '$compile',
    ...
    function RevenueRegisterController(
        ...
        var loadFunctionRd = ReportService.getRevenueRegister;
        ...
        $scope.getData = function () {
            ...
            var req = {
                method: 'GET',
                url: API_URL + '/api/sms/getDoanhThuDK?' + query,
                headers: {
