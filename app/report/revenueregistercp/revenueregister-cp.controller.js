angular
    .module('erpApp')
    .controller('RevenueRegisterCPController', RevenueRegisterCPController);

    RevenueRegisterCPController.$inject = ['$scope', '$rootScope', '$state', '$timeout', '$compile',
    ...
    function RevenueRegisterCPController(
        ...
        var loadFunctionRd = ReportService.getRevenueRegisterCP;
        ...
        $scope.getData = function () {
            ...
            var req = {
                method: 'GET',
                url: API_URL + '/api/sms/getDoanhThuDKByCpCode?' + query,
                headers: {
