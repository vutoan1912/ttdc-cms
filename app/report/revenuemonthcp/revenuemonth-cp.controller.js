angular
    .module('erpApp')
    .controller('RevenueMonthCPController', RevenueMonthCPController);

    RevenueMonthCPController.$inject = ['$scope', '$rootScope', '$state', '$timeout', '$compile',
    ...
    function RevenueMonthCPController(
        ...
        $scope.myColumnsRd = ["Gói dịch vụ", "Doanh thu", "Doanh thu tháng trước", "Doanh thu 2 tháng trước", "Tỷ lệ tháng trước", "Tỷ lệ 2 tháng trước", "Lũy kế năm", "Thời gian","CP CODE"];
        var fieldsRd =       ["cmd_code", "dt",  "dt_thangtruoc", "dt_2thangtruoc",  "tyle_thangtruoc",  "tyle_2thangtruoc",  "luyke_nam", "action_time","cp_code"];
        var fieldsTypeRd =   ["Text",     "Number",   "Number",      "Number",       "Number","Number","Number",     "DateTime","TextFilter"];
        $scope.fieldsValue =  [null,       null,       null,          null,           null,    null,     null,    null, null];
        var loadFunctionRd = ReportService.getRevenueMonthCP;
        ...
        $scope.getData = function () {
            ...
            var req = {
                method: 'GET',
                url: API_URL + '/api/sms/getDoanhThuThangByCpCode?' + query,
                headers: {
