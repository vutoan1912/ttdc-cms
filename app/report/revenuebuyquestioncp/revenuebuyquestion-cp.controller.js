angular
    .module('erpApp')
    .controller('RevenueBuyQuestionCPController', RevenueBuyQuestionCPController);

    RevenueBuyQuestionCPController.$inject = ['$scope', '$rootScope', '$state', '$timeout', '$compile',
    ...
    function RevenueBuyQuestionCPController(
        ...
        $scope.myColumnsRd = ["Gói dịch vụ", "Doanh thu", "Số lượng", "Thời gian","CP CODE"];
        var fieldsRd =       ["cmd_code", "dt",       "sl",      "action_time","cp_code"];
        var fieldsTypeRd =   ["Text",     "Number",   "Number",  "DateTime","TextFilter"];
        $scope.fieldsValue =  [null,       null,       null,          null , null];
        var loadFunctionRd = ReportService.getRevenueBuyQuestionCP;
        ...
        $scope.getData = function () {
            ...
            var req = {
                method: 'GET',
                url: API_URL + '/api/sms/getDoanhThuMTByCpCode?' + query,
                headers: {
