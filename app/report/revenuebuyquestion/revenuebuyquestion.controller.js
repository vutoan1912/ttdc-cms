angular
    .module('erpApp')
    .controller('RevenueBuyQuestionController', RevenueBuyQuestionController);

    RevenueBuyQuestionController.$inject = ['$scope', '$rootScope', '$state', '$timeout', '$compile',
    ...
    function RevenueBuyQuestionController(
        ...
        var loadFunctionRd = ReportService.getRevenueBuyQuestion;
        ...
        $scope.getData = function () {
            ...
            var req = {
                method: 'GET',
                url: API_URL + '/api/sms/getDoanhThuMT?' + query,
                headers: {
