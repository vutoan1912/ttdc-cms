angular
    .module('erpApp')
    .controller('RevenueRenewalCPController', RevenueRenewalCPController);

    RevenueRenewalCPController.$inject = ['$scope', '$rootScope', '$state', '$timeout', '$compile',
    ...
    function RevenueRenewalCPController(
        ...
        var loadFunctionRd = ReportService.getRevenueRenewalCP;
        ...
        $scope.getData = function () {
            ...
            var req = {
                method: 'GET',
                url: API_URL + '/api/sms/getDoanhThuGHByCpCode?' + query,
                headers: {
