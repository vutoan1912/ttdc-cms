angular
    ...
    function OutputSubController(
        ...
        $scope.myColumnsRd = ["Thời gian", "Đăng ký mới", "Đăng ký lại", "Tổng đăng ký", "Hệ thống hủy","Tự hủy","Tổng hủy", "gia hạn","Đăng ký thành công","Đăng ký thất bại","Đăng ký wap","Đăng ký SMS","Đăng ký CMS","Tỷ lệ trừ cước"];
        var fieldsRd =     ["ngay",     "dk_moi", "dk_lai", "tong_dk", "ht_huy", "tu_huy","tong_huy","gia_han","dk_success","dk_fail","dk_wap","dk_sms","dk_cms","tyle_charge"];
        var fieldsTypeRd = ["DateTime", "Number", "Number", "Number",  "Number", "Number","Number",  "Number" ,"Number",    "Number", "Number","Number","Number","Number"];
