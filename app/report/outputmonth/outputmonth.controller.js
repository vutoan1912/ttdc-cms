angular
    .module('erpApp')
    .controller('OutputMonthController', OutputMonthController);

    OutputMonthController.$inject = ['$scope', '$rootScope', '$state', '$timeout', '$compile',
    ...
    function OutputMonthController(
        ...
        var loadFunctionRd = ReportService.getOutputMonth;
        ...
        $scope.getData = function () {
            ...
            var req = {
                method: 'GET',
                url: API_URL + '/api/sms/getThongKeThang?' + query,
                headers: {
