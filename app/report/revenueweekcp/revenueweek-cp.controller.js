angular
    .module('erpApp')
    .controller('RevenueWeekCPController', RevenueWeekCPController);

    RevenueWeekCPController.$inject = ['$scope', '$rootScope', '$state', '$timeout', '$compile',
    ...
    function RevenueWeekCPController(
        ...
        $scope.myColumnsRd = ["Gói dịch vụ", "Doanh thu tuần", "Doanh thu tuần trước", "Lũy kế tháng", "Tỷ lệ", "Tỷ lệ lũy kế", "Thời gian","CP CODE"];
        var fieldsRd =       ["cmd_code", "dt_tuan",  "dt_tuantuoc", "luyke_thang",  "tyle",  "tyle_luyke", "action_time","cp_code"];
        var fieldsTypeRd =   ["Text",     "Number",   "Number",      "Number",       "Number","Number",     "DateTime","TextFilter"];
        $scope.fieldsValue =  [null,       null,       null,          null,           null,    null,         null, null];
        var loadFunctionRd = ReportService.getRevenueWeekCP;
        ...
        $scope.getData = function () {
            ...
            var req = {
                method: 'GET',
                url: API_URL + '/api/sms/getDoanhthuTuanByCpCode?' + query,
                headers: {
