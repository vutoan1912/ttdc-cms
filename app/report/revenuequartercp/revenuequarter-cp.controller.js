angular
    .module('erpApp')
    .controller('RevenueQuarterCPController', RevenueQuarterCPController);

    RevenueQuarterCPController.$inject = ['$scope', '$rootScope', '$state', '$timeout', '$compile',
    ...
    function RevenueQuarterCPController(
        ...
        $scope.myColumnsRd = ["Gói dịch vụ", "Doanh thu", "Doanh thu quý trước", "Tỷ lệ","Lũy kế năm", "Quý","CP CODE"];
        var fieldsRd =       ["cmd_code", "dt",       "dt_quytruoc", "tyle",   "luyke_nam", "type","cp_code"];
        var fieldsTypeRd =   ["Text",     "Number",   "Number",      "Number", "Number",    "Number" ,"TextFilter"];
        $scope.fieldsValue =  [null,       null,       null,          null,     null     ,   null  , null];
        var loadFunctionRd = ReportService.getRevenueQuarterCP;
        ...
        $scope.getData = function () {
            ...
            var req = {
                method: 'GET',
                url: API_URL + '/api/sms/getDoanhThuQuyByCpCode?' + query,
                headers: {
