angular
    ...
    RegisterController.$inject = ['$scope', '$rootScope', '$state', '$timeout', '$compile',
    ...
    function RegisterController(
        ...
        $scope.myColumnsRd = ["Số điện thoại", "Gói dịch vụ", "Tương tác", "Thời gian", "Kênh", "Giá cước", "Trừ cước"];
        var fieldsRd =     ["msisdn", "cmd_code", "type", "action_time", "channel", "price",  "priceReal"];
        var fieldsTypeRd = ["Text",   "Text",     "Text",  "DateTime",   "Text",    "Number", "Number"];
        var loadFunctionRd = SubService.getRegister;
