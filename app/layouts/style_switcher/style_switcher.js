angular
    ...
    .directive('styleSwitcher', function ($rootScope,$document,$state,$timeout) {
        return {
            restrict: 'E',
            templateUrl : 'app/layouts/style_switcher/style_switcher.html',
            ...
            link: function (scope, elem, attr) {
                ...
                scope.changeTheme = function($event,theme) {
                    ...
                    if(theme.class == '') {
                        ...
                        localStorage.setItem("erp_theme", theme.class);
                ...
                if((localStorage.getItem("erp_sidebar_mini") !== null && localStorage.getItem("erp_sidebar_mini") == '1')) {
                ...
                $('#style_sidebar_mini')
                    .on('ifChecked', function(event){
                        localStorage.setItem("erp_sidebar_mini", '1');
                        localStorage.removeItem('erp_sidebar_slim');
                    ...
                    .on('ifUnchecked', function(event){
                        localStorage.removeItem('erp_sidebar_mini');
                        $rootScope.styleSwitcherActive = false;
                        $timeout(function() {
                            $rootScope.miniSidebarActive = false;
                            $state.go($state.current, {}, {reload: true});
                ...
                // change input's state to checked if mini sidebar is active
                if((localStorage.getItem("erp_sidebar_slim") !== null && localStorage.getItem("erp_sidebar_slim") == '1')) {
                ...
                $('#style_sidebar_slim')
                    .on('ifChecked', function(event){
                        localStorage.removeItem('erp_sidebar_mini');
                        localStorage.setItem("erp_sidebar_slim", '1');
                        $rootScope.styleSwitcherActive = false;
                        $timeout(function() {
                            $rootScope.slimSidebarActive = true;
                            $state.go($state.current, {}, {reload: true});
                ...
                if((localStorage.getItem("erp_boxed_layout") !== null && localStorage.getItem("erp_boxed_layout") == '1')) {
                ...
                $('#style_layout_boxed')
                    .on('ifChecked', function(event){
                        localStorage.setItem("erp_boxed_layout", '1');
                        $rootScope.styleSwitcherActive = false;
                        $timeout(function() {
                            $rootScope.boxedLayoutActive = true;
                            $state.go($state.current, {}, {reload: true});
                    ...
                    .on('ifUnchecked', function(event){
                        localStorage.removeItem('erp_boxed_layout');
                        $rootScope.styleSwitcherActive = false;
                        $timeout(function() {
                ...
                if(localStorage.getItem("erp_theme") !== null) {
                    $rootScope.main_theme = localStorage.getItem("erp_theme");
                } else {
