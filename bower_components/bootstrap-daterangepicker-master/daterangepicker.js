            ...
            options.template = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                    '<div class="range_inputs">' +
                        '<button class="applyBtn" disabled="disabled" type="button" id="daterangepicker_apply"></button> ' +
                        '<button class="cancelBtn" type="button" id="daterangepicker_cancel"></button>' +
                    '</div>' +
                '</div>' +
            '</div>';
